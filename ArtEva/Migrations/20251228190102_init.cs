        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shops_AspNetUsers_OwnerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductImageSnapshot = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ExecutionDays = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reviews_Products_TargetId",
                        column: x => x.TargetId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reviews_Shops_TargetId",
                        column: x => x.TargetId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    ProviderRef = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipientCodename = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PickupInstructions = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "dbd64ccc-c404-4775-9d25-3bba0f7d2f42", new DateTime(2025, 12, 28, 19, 1, 1, 467, DateTimeKind.Utc).AddTicks(2889), "Administrator with full system access", "Admin", "ADMIN" },
                    { 2, "9cd3fe4a-f0df-45d9-aa13-fa56c97f0df8", new DateTime(2025, 12, 28, 19, 1, 1, 467, DateTimeKind.Utc).AddTicks(2900), "Customer who can browse and purchase artworks", "Buyer", "BUYER" },
                    { 3, "f36b3c09-c28d-4132-9db9-c1f2dd18658b", new DateTime(2025, 12, 28, 19, 1, 1, 467, DateTimeKind.Utc).AddTicks(2922), "Artist who can create shop and sell artworks", "Seller", "SELLER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_ReviewerUserId_TargetType_TargetId",
                table: "Reviews",
                columns: new[] { "ReviewerUserId", "TargetType", "TargetId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopFollowers_ShopId_UserId",
                table: "ShopFollowers",
